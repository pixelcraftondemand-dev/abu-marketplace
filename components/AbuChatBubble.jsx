...
export default function AbuChatBubble() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {open && (
        <div id="abu-support-chat" role="dialog" aria-label="ABU support chat" className="w-[360px] max-w-[calc(100vw-2rem)] rounded-[2rem] border border-slate-200 bg-white shadow-[0_30px_80px_rgba(15,23,42,0.18)]">
