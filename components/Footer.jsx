    ...
    const linkSections = [
        {
            ...
            links: [
                ...
                { text: "Smart Watches", path: '/shop?search=watch', icon: null },
                { text: "Smart Home", path: '/shop?search=smart', icon: null },
            ]
        },
        {
            title: "MARKETPLACE",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "032 110 054", path: 'tel:032110054', icon: PhoneIcon },
                { text: "abumarketplace.shop@gmail.com", path: 'mailto:abumarketplace.shop@gmail.com', icon: MailIcon },
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    ...
                    <div className="flex flex-wrap justify-between w-full md:w-[58%] gap-5 text-sm ">
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2026 ABU Marketplace. All rights reserved.
                </p>
            </div>
        </footer>
    );
